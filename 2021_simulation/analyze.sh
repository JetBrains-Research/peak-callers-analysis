...
T=$'\t'
echo "Modification${T}Mult${T}Library${T}I${T}TruePeaksFile${T}TruePeaks${T}TrueLength${T}Tool${T}PeaksFile${T}Fdr${T}Peaks${T}Length${T}Precision${T}Recall" >report.tsv
    ...
    for I in $(seq 1 $N); do
      ...
      for MULT in "${MULTS[@]}"; do
        ...
        for F in $(find $WORK_DIR/macs2/ -name "${NAME}*.narrowPeak"); do
          ...
          echo "${M}${T}$MULT${T}$LIB${T}$I${T}$TPF$T${TP}$T${TL}${T}Macs2$T$F${T}${FDR}$T${P}$T${L}$T${PR}$T${RE}" >> report.tsv
        done
        echo ""
        ...
        for F in $(find $WORK_DIR/macs2/ -name "${NAME}*.broadPeak"); do
          ...
          RE=$(bedtools intersect -a $F -b $TPF -wa -u | wc -l)
          echo "Fdr $FDR Peaks $P Precision $PR Recall $RE"
          echo "${M}${T}$MULT${T}$LIB${T}$I${T}$TPF$T${TP}$T${TL}${T}Macs2Broad$T$F${T}${FDR}$T${P}$T${L}$T${PR}$T${RE}" >> report.tsv
        done
        echo ""
        ...
        for F in $(find $WORK_DIR/sicer/ -name "${NAME}*-FDR*"); do
          ...
          RE=$(bedtools intersect -a $F -b $TPF -wa -u | wc -l)
          echo "Fdr $FDR Peaks $P Precision $PR Recall $RE"
          echo "${M}${T}$MULT${T}$LIB${T}$I${T}$TPF$T${TP}$T${TL}${T}SICER$T$F${T}${FDR}$T${P}$T${L}$T${PR}$T${RE}" >> report.tsv
        done
        echo ""
        ...
        for F in $(find $WORK_DIR/span/ -name "${NAME}_*_5.peak"); do
          ...
          RE=$(bedtools intersect -a $F -b $TPF -wa -u | wc -l)
          echo "Fdr $FDR Peaks $P Precision $PR Recall $RE"
          echo "${M}${T}$MULT${T}$LIB${T}$I${T}$TPF$T${TP}$T${TL}${T}SPAN-GAP5$T$F${T}${FDR}$T${P}$T${L}$T${PR}$T${RE}" >> report.tsv
        done
        echo ""
        ...
        for F in $(find $WORK_DIR/span/ -name "${NAME}_*_0.peak"); do
          ...
          RE=$(bedtools intersect -a $F -b $TPF -wa -u | wc -l)
          echo "Fdr $FDR Peaks $P Precision $PR Recall $RE"
          echo "${M}${T}$MULT${T}$LIB${T}$I${T}$TPF$T${TP}$T${TL}${T}SPAN-GAP0$T$F${T}${FDR}$T${P}$T${L}$T${PR}$T${RE}" >> report.tsv
        done
        echo ""
        ...
        for F in $(find $WORK_DIR/nbhmm2nz/ -name "${NAME}*.peak"); do
          ...
          RE=$(bedtools intersect -a $F -b $TPF -wa -u | wc -l)
          echo "Fdr $FDR Peaks $P Precision $PR Recall $RE"
          echo "${M}${T}$MULT${T}$LIB${T}$I${T}$TPF$T${TP}$T${TL}${T}SPAN-NZ2$T$F${T}${FDR}$T${P}$T${L}$T${PR}$T${RE}" >>report.tsv
        done
        echo ""
        ...
        for F in $(find $WORK_DIR/nbhmm3nz/ -name "${NAME}*.peak"); do
          ...
          RE=$(bedtools intersect -a $F -b $TPF -wa -u | wc -l)
          echo "Fdr $FDR Peaks $P Precision $PR Recall $RE"
          echo "${M}${T}$MULT${T}$LIB${T}$I${T}$TPF$T${TP}$T${TL}${T}SPAN-NZ3$T$F${T}${FDR}$T${P}$T${L}$T${PR}$T${RE}" >>report.tsv
        done
        echo ""
        ...
        for F in $(find $WORK_DIR/nbhmm4nz/ -name "${NAME}*.peak"); do
          ...
          RE=$(bedtools intersect -a $F -b $TPF -wa -u | wc -l)
          echo "Fdr $FDR Peaks $P Precision $PR Recall $RE"
          echo "${M}${T}$MULT${T}$LIB${T}$I${T}$TPF$T${TP}$T${TL}${T}SPAN-NZ4$T$F${T}${FDR}$T${P}$T${L}$T${PR}$T${RE}" >>report.tsv
        done
        echo ""
        ...
        for F in $(find $WORK_DIR/nbhmm3z/ -name "${NAME}*.peak"); do
          ...
          RE=$(bedtools intersect -a $F -b $TPF -wa -u | wc -l)
          echo "Fdr $FDR Peaks $P Precision $PR Recall $RE"
          echo "${M}${T}$MULT${T}$LIB${T}$I${T}$TPF$T${TP}$T${TL}${T}SPAN-Z3$T$F${T}${FDR}$T${P}$T${L}$T${PR}$T${RE}" >>report.tsv
        done
        echo ""
        ...
        for F in $(find $WORK_DIR/nbhmm4z/ -name "${NAME}*.peak"); do
          ...
          RE=$(bedtools intersect -a $F -b $TPF -wa -u | wc -l)
          echo "Fdr $FDR Peaks $P Precision $PR Recall $RE"
          echo "${M}${T}$MULT${T}$LIB${T}$I${T}$TPF$T${TP}$T${TL}${T}SPAN-Z4$T$F${T}${FDR}$T${P}$T${L}$T${PR}$T${RE}" >>report.tsv
        done
        echo ""
        ...
        for F in $(find $WORK_DIR/islands/ -name "${NAME}_*.peak"); do
          ...
          RE=$(bedtools intersect -a $F -b $TPF -wa -u | wc -l)
          echo "Fdr $FDR Peaks $P Precision $PR Recall $RE"
          echo "${M}${T}$MULT${T}$LIB${T}$I${T}$TPF$T${TP}$T${TL}${T}SPAN-Islands$T$F${T}${FDR}$T${P}$T${L}$T${PR}$T${RE}" >>report.tsv
        done
        echo ""
      done
    done
